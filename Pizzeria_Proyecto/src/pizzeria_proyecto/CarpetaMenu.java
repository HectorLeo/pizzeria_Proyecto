...
public class CarpetaMenu extends javax.swing.JFrame {
    ...
    /*public void mostrarClientes(JComboBox<CarpetaMenu> comboCliente){
        try {
            Conexion con = new Conexion();
            con.ConexionPostgres();
            ResultSet rs = con.consultar("SELECT cedula_cli, nombre_cli, apellido_cli, edad_cli FROM cliente ORDER BY nombre_cli ASC");
            while(rs.next()){
                comboCliente.addItem(
                        new CarpetaMenu(
                                rs.getString("cedula_cli"),
                                rs.getString("nombre_cli"),
                                rs.getString("apellido_cli"),
                                rs.getString("edad_cli")
                        )
                );
            }
        } catch (Exception ex) {
            Logger.getLogger(CarpetaMenu.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "ERROR AL MOSTRAR LOS CLIENTES"+edad);
        }
    }*/
    ...
    String PizzaHM=null,PizzaHG=null, PizzaHF=null,
            PizzaMM = null,PizzaMG = null,PizzaMF = null,
            PizzaPM = null,PizzaPG = null,PizzaPF = null,
            PizzaRC = null,PizzaRS = null,PizzaRM = null,
            PizzaP = null;
    ...
    private void initComponents() {
        ...
        jLabel35.setText("$ 20");
        jPanel5.add(jLabel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 250, -1, -1));
        ...
        jPanel5.add(jCbRefrescoC, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 250, 50, -1));

        jLabel38.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ImgPizza/cocaC.png"))); // NOI18N
        jPanel5.add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 20, -1, -1));
        ...
        jPanel5.add(jCbRefrescoSprite, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 250, 50, -1));

        jLabel39.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ImgPizza/Sidral Mundet retornable.png"))); // NOI18N
        jPanel5.add(jLabel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 40, -1, -1));

        jLabel40.setText("$ 15");
        jPanel5.add(jLabel40, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 250, -1, -1));
        ...
        jPanel5.add(jCbRefrescoManzanita, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 250, 50, -1));

        jLabel44.setText("$ 18");
        jPanel5.add(jLabel44, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 250, -1, -1));
        ...
        jPanel5.add(Papas, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 250, 50, 20));

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ImgPizza/papas.png"))); // NOI18N
        jPanel5.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 20, -1, -1));

        jLabel18.setText("$ 20");
        jPanel5.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 250, -1, -1));

        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ImgPizza/sprite.png"))); // NOI18N
        jPanel5.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 40, -1, -1));

        jTabbedPane2.addTab("Refrescos/papas", jPanel5);
    ...
    private void jCbMedianaMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCbMedianaMActionPerformed
        ...
        PizzaMM=("Pizza Mexicana Mediana");
    ...
    private void jCbFamiliarMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCbFamiliarMActionPerformed
        ...
        PizzaMF=("Pizza Mexicana Familiar");
    ...
    private void jCbMedianaPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCbMedianaPActionPerformed
        ...
        PizzaPM=("Pizza Peperoni Mediana");
    ...
    private void jCbFamiliarPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCbFamiliarPActionPerformed
        ...
        PizzaPF=("Pizza Peperoni Familiar");
    ...
    private void jCbRefrescoCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCbRefrescoCActionPerformed
        ...
        CantidadTotal=CantidadTotal+CantidadCoca;
        PizzaRC=("Refresco Coca Cola");
        // TODO add your handling code here:
